 ...
 */
class getUnitelibelleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UnitelibelleRepository' shared autowired service.
     *
     * @return \App\Repository\UnitelibelleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UnitelibelleRepository.php';

        return $container->privates['App\\Repository\\UnitelibelleRepository'] = new \App\Repository\UnitelibelleRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
