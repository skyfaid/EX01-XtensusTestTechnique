...
return [
    ...
    [ // $dynamicRoutes
        ...
        222 => [[['_route' => 'app_produit_show', '_controller' => 'App\\Controller\\ProduitController::show'], ['produitreference'], ['GET' => 0], null, false, true, null]],
        238 => [[['_route' => 'app_produit_edit', '_controller' => 'App\\Controller\\ProduitController::edit'], ['produitreference'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        252 => [
